...
// Dev API Unlimited
$season_request = wp_remote_get( 'https://api.sportsdata.io/v3/nfl/scores/json/CurrentSeason', $nfl_header_dak );
$season_body    = json_decode( wp_remote_retrieve_body( $season_request ) );

$standing_request = wp_remote_get( 'https://api.sportsdata.io/v3/nfl/scores/json/Standings/'.$season_body->Season.'',  $nfl_header_dak );
